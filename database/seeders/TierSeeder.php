    ...
    public function run(): void
    {
        ...
        $tiers = [
            [
                ...
                'price' => 2990,
                'image_key' => 'soul',
                'telegram_chat_id' => -4874179160,
                'tg_greet' => ", рады приветствовать вас на нашей в группе \"Душа\"!\n\nПоздравляем с началом пути к гармонии, внутреннему развитию и душевному благополучию.",
                'route' => 'soul',
            ...
            [
                ...
                'price' => 2990,
                'image_key' => 'food',
                'telegram_chat_id' => -4874389201,
                'tg_greet' => ", рады приветствовать вас в нашей группе \"Питание\"!\n\nПоздравляем с началом вашего пути к более здоровому и сбалансированному питанию.",
                'route' => 'nutrition',
            ...
            [
                ...
                'price' => 2990,
                'image_key' => 'sport',
                'telegram_chat_id' => -4892990636,
                'tg_greet' => ", рады приветствовать вас в нашей группе \"Тело\"!\n\nПоздравляем с началом вашего пути к укреплению здоровья, физическому развитию и активному образу жизни.",
                'route' => 'body',
        ...
        foreach ($tiers as $tier) {
            ...
            Tier::factory(
                [
                    ...
                    'route' => $tier['route'],
                    'price' => $tier['price'],
                    'telegram_chat_id' => $tier['telegram_chat_id'],
                    'tg_greet' => $tier['tg_greet'],
                ]
            )
