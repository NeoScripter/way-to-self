...
export default function Practices() {
    const { practices, menuItems } = usePage<{
    ...
    return (
        ...
        >
            ...
            <ArtLayer
                img={Cinnamon}
                tinyImg={TinyCinnamon}
                className="top-1/2 right-0 w-2/5 max-w-160"
            />
            <ArtLayer
                img={Broom}
                tinyImg={TinyBroom}
