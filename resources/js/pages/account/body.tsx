import TinyDesktopBg from '@/assets/images/body/account-body-desktop-tiny.webp';
import DesktopBg from '@/assets/images/body/account-body-desktop.webp';
import TinyMobileBg from '@/assets/images/body/account-body-tablet-tiny.webp';
import MobileBg from '@/assets/images/body/account-body-tablet.webp';
...
import { accountBodyCards } from '@/lib/data/card-data';
