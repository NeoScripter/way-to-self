    ...
    return (
        ...
        >
            <div className={cn('relative', className)}>
                <ListboxButton className="focus-visible:border-ring text-sm md:text-base text-center flex h-12 w-full cursor-pointer items-center justify-between rounded-lg border border-text-black bg-white px-4 py-1 text-text-black shadow-sm transition-[color,box-shadow] outline-none hover:ring-[3px] hover:ring-gray-600/20 focus-visible:ring-[3px] focus-visible:ring-gray-600/20">
                ...
                <ListboxOptions className="focus-visible:border-ring absolute z-10 mt-1 w-full rounded-md border border-text-black bg-white py-1 shadow-sm transition-[color,box-shadow] outline-none hover:ring-[3px] hover:ring-gray-600/20 focus-visible:ring-[3px] focus-visible:ring-gray-600/20">
                    {options.map((opt) => (
                        ...
                        >
                            {({ selected, focus }) => (
                                <div
                                    className={`cursor-pointer text-center px-3 py-1 ${
