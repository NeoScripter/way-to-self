...
export default function LightBtn({
    ...
    return (
        <button
            type={type}
            className={cn(
                'isabled:pointer-events-none flex w-100 max-w-full cursor-pointer justify-between rounded-lg bg-white px-[1.25em] py-[0.75em] text-center text-sm shadow-xs transition-[color,box-shadow] outline-none disabled:opacity-50 md:text-base',
                isActive
