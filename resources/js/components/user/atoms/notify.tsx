...
export default function notify(message: string) {
    toast.custom(
        (t) => (
            <div className="font-display relative w-full max-w-md rounded-md border-2 border-white/20 bg-card-backdrop-gray p-4 font-medium text-white backdrop-blur-sm">
                <button
