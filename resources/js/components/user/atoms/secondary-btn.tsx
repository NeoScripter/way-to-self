...
export default function SecondaryBtn({ children, href, onClick, className }: SecondaryBtnProps) {
    const baseClass = cn("rounded-full block cursor-pointer w-max border-2 border-white text-white py-[0.75em] px-[1.25em] text-center cursor-pointer transition-colors duration-200 ease-in-out hover:bg-dark-swamp/60", className);
