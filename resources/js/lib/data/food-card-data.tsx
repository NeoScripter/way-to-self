...
export const foodCardData: FoodCardData[] = [
    {
        ...
        text: (
            <p>
                Сбалансированные{' '}
                <span className="info-card__large">Рецепты</span>{' '}
    ...
    },
    {
        ...
        text: (
            <p>
                <span className="info-card__indent">
                    Подсказки по составлению
                </span>{' '}
    ...
    },
    {
        ...
        text: (
            <p>
                <span className="info-card__large">Ответы</span> на популярные
                вопросы
            </p>
        ),
        img: FoodCard3,
    ...
    },
    {
        ...
        text: (
            <p>
                Секретный чат в{' '}
                <span className="info-card__large">Телеграм</span>
            </p>
        ),
        img: FoodCard4,
