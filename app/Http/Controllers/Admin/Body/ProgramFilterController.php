...
class ProgramFilterController extends Controller
{
    ...
    {
        $filters = CategoryFilter::where('category', CategoryType::PROGRAMS)
            ->latest()
            ->get()
            ->groupBy('title');

        return Inertia::render('admin/body/program-filters', [
            'filters' => fn() => $filters,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated['category'] = CategoryType::PROGRAMS;
    ...
    public function massDestroy(Request $request)
    {
        ...
        CategoryFilter::where(function ($q) {
            $q->where('category', CategoryType::PROGRAMS)
