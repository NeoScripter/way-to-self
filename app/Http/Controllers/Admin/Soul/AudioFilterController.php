...
class AudioFilterController extends Controller
{
    ...
    {
        $filters = CategoryFilter::where('category', CategoryType::AUDIOS)
            ->latest()
            ->get()
            ->groupBy('title');

        return Inertia::render('admin/soul/audio-filters', [
            'filters' => fn() => $filters,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated['category'] = CategoryType::AUDIOS;
    ...
    public function massDestroy(Request $request)
    {
        ...
        CategoryFilter::where(function ($q) {
            $q->where('category', CategoryType::AUDIOS)
